...
prefill_proc = subprocess.Popen(
    [
        sys.executable, "pd_server_v2.py",
        "--role", "prefill",
        "--model", model_path,
...
for _ in range(60):
    ...
    if line:
        prefill_output.append(line.strip())
...
for _ in range(60):
    ...
    if line:
        decode_output.append(line.strip())
...
print(f"  Decode response: {decode_response}")
